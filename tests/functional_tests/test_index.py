...
chrome_driver = "C:/Users/nikita/PycharmProjects/PipelinePractice/tests/functional_tests/yandexdriver.exe" if "ChromeWebDriver" not in os.environ.keys() else os.path.join(
